...
export function LoginForm() {
  ...
  return <div className="w-full max-w-[470px] rounded-[30px] border border-[#eadfda] bg-[#fffdfb]/95 p-6 shadow-[0_28px_90px_rgba(50,21,38,.10),0_2px_8px_rgba(50,21,38,.04)] backdrop-blur-xl sm:p-8 lg:p-7 xl:p-9">
    <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#f2d5cd] bg-[#fff2ed] px-3 py-1.5 text-[11px] font-bold uppercase tracking-[.13em] text-[#9c352b]"><ShieldCheck className="size-3.5"/>Secure workspace access</div>
    <h1 className="text-3xl font-bold tracking-[-.045em] text-slate-950 sm:text-[2.15rem]">{creatingAccount ? "Create your hotel account" : "Welcome to the shift."}</h1>
    <p className="mt-2.5 text-sm leading-6 text-slate-500">{creatingAccount ? "Set up your organization and first property." : "Sign in and pick up exactly where your team left off."}</p>
    ...
    <form onSubmit={submit} className="mt-5 space-y-4">
      ...
      <Button className="h-12 w-full bg-[#321526] shadow-[0_10px_24px_rgba(50,21,38,.18)] hover:bg-[#1f0d18]" disabled={loading}>{loading ? <><Loader2 className="size-4 animate-spin"/>Please wait…</> : creatingAccount ? "Create account" : "Enter StaySync"}</Button>
    </form>
