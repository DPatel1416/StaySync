    ...
    <div className="mx-auto max-w-3xl">
      ...
      <section className="mt-8 overflow-hidden rounded-[30px] border border-[#dedfd8] bg-[#fbfcf8] shadow-[0_28px_90px_rgba(21,23,19,.10)] sm:mt-12">
        ...
        <form onSubmit={submit} className="space-y-6 px-6 py-7 sm:px-10 sm:py-9">
          <fieldset className="space-y-4"><legend className="mb-4 flex items-center gap-2 text-sm font-bold text-slate-900"><Building2 className="size-4 text-brand"/>Property identity</legend><div className="grid gap-4 sm:grid-cols-2"><label><span className="mb-2 block text-sm font-semibold text-slate-700">Organization name</span><input name="organizationName" required className={fieldClass} placeholder="Your hotel group"/></label><label><span className="mb-2 block text-sm font-semibold text-slate-700">Property name</span><input name="propertyName" required className={fieldClass} placeholder="Your property name"/></label></div><label className="block sm:max-w-[calc(50%-0.5rem)]"><span className="mb-2 flex items-center gap-2 text-sm font-semibold text-slate-700"><BedDouble className="size-4 text-slate-400"/>Number of guest rooms</span><input name="roomCount" type="number" min="1" max="10000" required className={fieldClass} placeholder="100"/></label></fieldset>
